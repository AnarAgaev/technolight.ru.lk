...
const videoInstructionsList = [
	{
		views: 2,
		title: 'Видео инструкция Магнитной трековой системы и что-то там еще',
		link: 'https://aws.technolight.ru/technolight/public/images/projects/2024-04-10/01HV47G90K4T9D5GYKF25KT5KZ.webp?v=1722520080',
	},
	{
		views: 33,
		title: 'Регулировка высоты светильника Глобо 135 подвесной',
		link: 'https://aws.technolight.ru/technolight/public/images/projects/2024-01-31/01HNFXY86JEPZJ18MJJ1KNQG97.webp?v=1722520080',
	},
	{
		views: 75,
		title: 'Установка светильника Лайн',
		link: 'https://aws.technolight.ru/technolight/public/images/projects/2024-04-10/01HV47SRSDRVSKCTQ619WYXSFZ.webp?v=1722520080',
	},
	{
		views: 83,
		title: 'Установка в ГКЛ монтажных комплектов Зеро и Фрейм Зеро',
		link: 'https://aws.technolight.ru/technolight/public/images/projects/2024-04-10/01HV480SFQBX15F3PF50J0J2DZ.webp?v=1722520081',
	},
	{
		views: 27,
		title: 'Встраиваемый в гипсокартон шинопровод PROFI 48V от TECHNOLIGHT',
		link: 'https://aws.technolight.ru/technolight/public/images/projects/2024-04-10/01HV47G90K4T9D5GYKF25KT5KZ.webp?v=1722520080',
	},
	{
		views: 34,
...
const catalogsList = [
	{
		...
		size: '34.83 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2025/01JQEJ926274DB68T4CQ7X1BVT.jpg',
	},
	{
		id: 2,
		...
		size: '9.5 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2024/01J7ZGJ60VD9YSWD6ACTS1FCMA.jpg',
	},
	{
		id: 3,
		label: 'Брошюра HALO',
		...
		size: '6.67 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2024/01J7ZGNZ6GTN6384R2ZJEFDXRT.jpg',
	},
	{
		id: 4,
		...
		size: '1.2 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2024/01JBH2G8E7PX3KHP22NGVG0YF2.jpg',
	},
	{
		id: 5,
		label: 'БРОШЮРА PRISM',
		...
		size: '2.7 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2025/01JQ4A5PBG326R13GQ1JZ56RE2.jpg',
	},
	{
		id: 6,
		...
		size: '1.86 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2025/01JVCGYFAF52K8GWPT4RYWMVSM.jpg',
	},
	{
		id: 7,
		...
		size: '6.49 MB',
		image:
			'https://storage.yandexcloud.net/s3files/previews/2025/01K30NMZF5BFCAKJCCA6KXV11F.jpg',
	},
]
				...
				<VStack align="stretch" gap="0">
					...
					{filesList.map((file, index) => (
						<HStack
							...
							py="3"
							borderRadius="6px"
							bg={index % 2 === 0 ? 'gray.100' : 'transparent'}
						>
							<Flex
								direction={{base: 'column', md: 'row'}}
								align={{md: 'center'}}
								...
								w="full"
							>
								<Link href="#" fontSize="14px" download>
									{file.label}
								</Link>
								<Text
									flexShrink={0}
