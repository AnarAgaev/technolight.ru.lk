...
const selectors = [
	...
	},
	{
		...
		options: [
			...
			{
				label: 'ЛАЙТ ДЕКОР',
				info: 'ул. Машиностроительная 12А, ТЦ Регул, 2 этаж офис 7, салон SWG',
				value: 'BFG7753',
			},
			{
				label: 'Магазин "Алые Паруса"',
				info: 'Рыбно-Слободский район ПГТ Рыбная Слобода, ул. З.Шаймарданова, 59',
				value: 'CLR0087',
			},
			{
				label: 'Магазин "Мультисвет"',
				info: 'г. Южно-Сахалинск, ул. Комсомольская, 314 А',
				value: 'PURE347',
			},
			{
				label: 'Магазин люстр "Лидер света" ',
				info: 'ул. Мусина, 29Б, корпус 2',
				value: '1324PURE347',
			},
		],
	},
		...
		<ContentLayout>
			...
			<VStack align="stretch" gap="6">
				...
				<Heading size="sm" maxW="400px" margin="0 auto" textAlign="center">
					У вас еще нет ни одного заказа. Нажмите на кнопку «Создать заказ», что
					бы создать ваш первый заказ, выбрав предварительно юр.лицо, договор и
					адрес ТТ
				</Heading>
