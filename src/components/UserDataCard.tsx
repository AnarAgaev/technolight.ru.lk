...
import { Flex, Heading, Text, Menu, Portal, Icon, Box, useBreakpointValue } from "@chakra-ui/react"
								...
								{({ open }) => (
									<>
										...
										<Portal>
											<Menu.Positioner>
												<Menu.Content>
													<Menu.Item value="contributor-id-1" cursor={"pointer"}>Другое Юр. Лицо</Menu.Item>
													<Menu.Item value="contributor-id-2" cursor={"pointer"}>Другое Юр. Лицо</Menu.Item>
													<Menu.Item value="contributor-id-3" cursor={"pointer"}>Другое Юр. Лицо</Menu.Item>
													<Menu.Item value="contributor-id-4" cursor={"pointer"}>Другое Юр. Лицо</Menu.Item>
												</Menu.Content>
											</Menu.Positioner>
										</Portal>
									</>
